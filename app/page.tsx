...
export default function Page() {
  ...
  const skills = [
    ...
    'MongoDB', 'Git', 'REST APIs', 'Vercel'
  ]

  const projects = [
    {
      title: 'WanderLust',
      description: 'A comprehensive travel planning application that helps users discover, plan, and share their travel experiences.',
      tech: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS'],
      github: 'https://github.com/namitsrivastava/wanderlust',
    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="space-y-6">
              <div className="bg-background rounded-lg border border-border p-6">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">•</span>
                    <span>Performance and scalability first</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">•</span>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, i) => (
              <div
                key={i}
                className="bg-card border border-border rounded-lg p-4 hover:border-primary transition-colors cursor-default group"
              >
            ...
            {projects.map((project, i) => (
              ...
              >
                <div className="grid md:grid-cols-2 gap-6 p-8">
                  ...
                  <div className="relative h-64 md:h-auto rounded-lg bg-card border border-border flex items-center justify-center overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-accent/10"></div>
                    <div className="text-center relative z-10">
                      <p className="text-3xl font-bold text-primary/50">{project.title}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="border-t border-border bg-card/50 py-8 mt-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-muted-foreground text-sm">
          <p>&copy; 2024 Namit Srivastava. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
